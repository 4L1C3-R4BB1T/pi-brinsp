    ...
    <div class="table-responsive">
        ...
        ?>
            <table class="table table-striped table-hover table-bordered text-center">
                ...
                <tbody>
                    <?php
                    foreach ($this->dados['listProd'] as $produto) {
                        extract($produto);
                    ?>
                        <tr>
                            <th><?= $id ?></th>
                            ...
                            <td>
                                <span class="d-md-block">
                                    <?php
                                    if ($this->dados['botao']['vis_produto']) {
                                        echo "<a href='" . URL . "adm-produtos/moreProduto/$id' class='btn btn-outline-primary btn-sm mr-2'>Visualizar</a>";
                                    }
